...
🔗 Протестируйте калькулятор по ссылке: [Пример работы](https://t0adsage.github.io/element-calc/)

📂 Исходный код доступен на GitHub: [Репозиторий](https://github.com/t0adsage/element-calc)
